    ...
    <main class="mx-auto w-full max-w-6xl px-5 pb-24 md:px-8">
        ...
        @if (! empty($liveVendors) && count($liveVendors) > 0)
            <section class="pt-24 md:pt-32">
                ...
                {{-- Negative margins let the strip bleed to the viewport edges so the right-side cards visibly hint at more content. --}}
                <div class="-mx-6 overflow-x-auto md:-mx-10 lg:-mx-16">
                    <ol class="flex snap-x snap-mandatory gap-4 px-6 pb-2 md:px-10 lg:px-16">
